...
sudo apt install -y curl wget unzip lsb-release software-properties-common net-tools ufw dnsutils git
...
if [ ! -f "$WP_CONFIG" ]; then
    ...
    # Set DB defaults (assumes local MariaDB/MySQL installed; user should update)
...
# Add reverse proxy and HTTPS support
